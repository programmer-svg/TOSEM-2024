...
int int_1_wihilStmt_4_0
int_1_wihilStmt_4_0 = 5
int int_2_wihilStmt_4_0
int_2_wihilStmt_4_0 = 0
int int_3_wihilStmt_4_0
int_3_wihilStmt_4_0 = 0
int int_4_wihilStmt_4_0
int_4_wihilStmt_4_0 = 0
while int_2_wihilStmt_4_0 < int_1_wihilStmt_4_0{
    int_2_wihilStmt_4_0 =  int_2_wihilStmt_4_0 + 1
    if (int_3_wihilStmt_4_0 < 100){
        int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 + int_2_wihilStmt_4_0
    }
    if (int_3_wihilStmt_4_0 < 1000){
        int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 + 100
    }
    if (int_3_wihilStmt_4_0 < 10000){
        int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 + 1000
    }
    while int_2_wihilStmt_4_0 < int_3_wihilStmt_4_0{
        int_2_wihilStmt_4_0 =  int_2_wihilStmt_4_0 * 2
        if (int_3_wihilStmt_4_0 < 100){
            int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 + 10
        }
        if (int_3_wihilStmt_4_0 < 1000){
            int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 + 100
        }
        ...
        if (int_3_wihilStmt_4_0 < 100000){
            int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 + 10000
        }
        while int_2_wihilStmt_4_0 < int_4_wihilStmt_4_0{
            int_2_wihilStmt_4_0 =  int_2_wihilStmt_4_0 * 2
            if (int_4_wihilStmt_4_0 < 100){
                int_4_wihilStmt_4_0 =  int_4_wihilStmt_4_0 + 10
            }
            if (int_4_wihilStmt_4_0 < 1000){
                int_4_wihilStmt_4_0 =  int_4_wihilStmt_4_0 + 100
            }
            if (int_4_wihilStmt_4_0 < 10000){
                int_4_wihilStmt_4_0 =  int_4_wihilStmt_4_0 + 1000
            }
            if (int_4_wihilStmt_4_0 < 100000){
                int_4_wihilStmt_4_0 =  int_4_wihilStmt_4_0 + 10000
            }
            while int_3_wihilStmt_4_0 < int_4_wihilStmt_4_0{
                int_3_wihilStmt_4_0 =  int_3_wihilStmt_4_0 * 2
                if (int_4_wihilStmt_4_0 < 100){
                    int_4_wihilStmt_4_0 =  int_4_wihilStmt_4_0 + 10
                }
                if (int_4_wihilStmt_4_0 < 1000){
...
int function_1_functionDef_4_0 ( int a, int b, int c, int d) {
    if (a > b){
        if (a > c){
            if (a > d){
                return a
...
int function_1_functionDef_2_2 ( int a, int b, int c) {
    if (a > b){
        if (a > c){
            return a
        }
