...
export class FundamentalType implements Type {
    ...
    public static readonly voidType = new FundamentalType("void", TypeKind.Void, ReferenceKind.Instance);
    public name: string;
    ...
    public constructor(name: string, typeKind = TypeKind.Unknown, referenceKind = ReferenceKind.Irrelevant,inner:Type[] = []) {
        this.name = name;
