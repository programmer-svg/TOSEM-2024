...
import { SymbolTableOptions, SymbolConstructor, Type } from "./types";
...
export interface Output {
    /**
     * 记录该文件A引用的文件B 当文件A发生修改时，即A1=>A2,会用到此值
     * 因为A1 != A2,所以当A2 diagnose之前时，需要根据ref值，修改A1的引用文件B 的refd值，进行删去
     * 之后再按照A2的引用关系来看B的refd要不要添加A
     * 
     * TODO 文件重命名，删除等文件操作
     */
    ref:Set<string>,
    ...
    /**
     * 记录引用文件A 的文件Blist 当当前文件A return值发生变化时，修改Blist
     * 
     */
    refd:Set<string>
}
...
export interface ISymbolTable extends IScopedSymbol {
     ...
     */
    symbolWithContext(context: SUnit): Promise<BaseSymbol | undefined>;
     ...
     */
    symbolWithContextSync(context: SUnit): BaseSymbol | undefined;
...
export class SymbolTable extends ScopedSymbol implements ISymbolTable,Output {
    /**  Other symbol information available to this instance. */
    public type: Type | undefined;
    public scope: Scope|undefined = undefined;
    public ref:Set<string> = new Set<string>;
    public refd:Set<string> = new Set<string>;
    ...
    public async symbolWithContext(context: SUnit): Promise<BaseSymbol | undefined> {
        /**
    ...
    public symbolWithContextSync(context: SUnit): BaseSymbol | undefined {
        /**
         * Local function to find a symbol recursively.
         *
         * @param symbol The symbol to search through.
